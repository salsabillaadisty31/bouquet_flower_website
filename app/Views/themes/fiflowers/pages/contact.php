...
<?= $this->section('konten'); ?>
<div class="hero-wrap hero-bread" style="background-image: url('<?= base_url('assets/themes/fiflowers/images/background-13.jpg'); ?>');">
  <div class="container">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 ftco-animate text-center">
        <p class="breadcrumbs"><span class="mr-2"><?php echo anchor(base_url(), 'Home'); ?></span> <span>Hubungi Kami</span></p>
        <h1 class="mb-0 bread" style="font-family:Amatic SC, cursive; font-size:8vw; font-weight:bolder;">Hubungi Kami</h1>
      </div>
    </div>
  </div>
</div>
...
<section class="ftco-section contact-section bg-light">
  <div class="container">
    <div class="row d-flex mb-5 contact-info">
      <div class="w-100"></div>
      <div class="col-md-3 d-flex" style="color:black;">
      ...
      <div class="col-md-3 d-flex"  style="color:black;">
        <div class="info bg-white p-4">
          <p><span>Website</span> www.bouquetfiflowers.com</p>
        </div>
      </div>
    </div>
