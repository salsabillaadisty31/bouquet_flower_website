  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 ftco-animate text-center">
        ...
        <h1 class="mb-0 bread" style="font-family:Amatic SC, cursive; font-size:6vw; font-weight:bolder;">Keranjang Belanja Saya</h1>
      </div>
    </div>
  </div>
</div>
        ...
        <div class="row justify-content-end">
          ...
          <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
            <div class="cart-total mb-5">
              <h3 style=" font-weight:bolder; color:white">Rincian Keranjang</h3>
              <p class="d-flex" style="color:white;">
                <span>Subtotal</span>
              ...
              <hr>
              <p class="d-flex total-price" style="color:white;">
                <span>Total</span>
                <span class="n-total font-weight-bold" style="color:white;">Rp <?php echo format_rupiah($total_price); ?></span>
              </p>
            </div> 
            <p><button type="submit" class="btn btn-primary py-3 px-4" style="margin-top:10px;">Checkout</button></p>
          </div>
        </div>
      </form>
    <?php else : ?>
