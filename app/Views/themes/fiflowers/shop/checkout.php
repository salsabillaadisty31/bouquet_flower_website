                ...
                <div class="col-xl-5">
                    <div class="row mt-5 pt-3">
                        <div class="col-md-12 d-flex mb-5">
                            <div class="cart-detail cart-total p-3 p-md-4" style="color:white;">
                                <h3 class="billing-heading mb-4" style="color: white; font-weight:bolder">Rincian Belanja</h3>
                                <p class="d-flex">
                                    <span>Subtotal</span>
                                ...
                                <p class="d-flex total-price">
                                    <span>Total</span>
                                    <span style="color:white; font-weight:bolder">Rp <?php echo format_rupiah($total); ?></span>
                                </p>
                            </div>
                        </div>
                        <div class="col-md-12">
