...
<section class="ftco-section ftco-Keranjang Belanja">
    <div class="container">
        ...
        <div class="card card-primary">
            <div class="card-header" style="background: rgb(175, 97, 90); color :white;">
                <h5 class="card-heading" style="color :white;">Data Penerima</h5>
            </div>
            <div class="card-body p-0">
                <table class="table table-hover table-striped table-hover">
                    <tr>
                        <td style="background: rgb(175, 97, 90); color :white;">Nama</td>
                        <td><b><?php echo $delivery_data->customer->name; ?></b></td>
                    </tr>
                    <tr>
                        <td style="background: rgb(175, 97, 90); color :white;">No. HP</td>
                        <td><b><?php echo $delivery_data->customer->phone_number; ?></b></td>
                    </tr>
                    <tr>
                        <td style="background: rgb(175, 97, 90); color :white;">Alamat</td>
                        <td><b><?php echo $delivery_data->customer->address; ?></b></td>
                    </tr>
                    <tr>
                        <td style="background: rgb(175, 97, 90); color :white;">Catatan</td>
                ...
                <div class="text-center actionRow">
                    <?php if ($data->payment_method == 1) : ?>
                        <?php if ($data->order_status == 1) : ?>
                            ...
                            <a href="<?php echo base_url('customer_payments/confirm?order=' . $data->id); ?>" class="btn" style="margin-bottom:20px; background-color:rgb(175, 97, 90); color:white;">Konfirmasi Pembayaran</a>
                            <br>
                            <a href="#" class="btn" data-toggle="modal" data-target="#cancelModal" style="margin-bottom:20px; background-color:rgb(175, 97, 90); color:white;">Batalkan</a>
