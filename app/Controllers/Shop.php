...
class Shop extends BaseController
{
    ...
    public function product($id = 0, $sku = '')
    {
        if ($id == 0 || empty($sku)) {
            ...
            if ($this->product->is_product_exist($id, $sku)) {
                ...
                return view('themes\fiflowers\shop\view_single_product', $product);
            } else {
                throw \CodeIgniter\Exceptions\PageNotFoundException::forPageNotFound();
            }
        }
    ...
    public function cart()
    {
        ...
        return view('themes\fiflowers\shop\cart', $data);
    }
    ...
    public function checkout($action = '')
    {
        ...
        switch ($action) {
            ...
            default:
                ...
                return view('themes\fiflowers\shop\checkout', $params);
                break;
            case 'order':
                ...
                return redirect()->to(site_url('customers/orders/view/' . $order));
                break;
        }
    }
